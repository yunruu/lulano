...
const components: JSXMapSerializer = {
  heading1: ({ children }) => (
    <Heading
      as="h1"
      size="xl"
      className="mb-4 md:mb-8 mt-12 first:mt-2 last:mb-0 max-w-xl"
    >
      {children}
    </Heading>
  ),
    ...
    <>
      ...
      {slice.variation === "horizontalStack" && (
        <OuterBound
          ...
          data-slice-variation={slice.variation}
        >
          <div className="grid grid-cols-1 md:grid-cols-2 place-items-center text-start">
            <div className="grid grid-rows-[1fr,auto,auto] h-fit">
              ...
              <PrismicRichText
                ...
                components={{
                  paragraph: ({ children }) => (
                    <p className="text-xl font-normal leading-8 font-body text-slate-600 mb-4 md:mb-8 max-w-md">
                      {children}
                    </p>
                  ),
                }}
