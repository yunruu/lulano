...
export interface FeaturesSliceDefaultItem {
   ...
   */
  icon: prismic.SelectField<"calendar" | "music" | "hourglass" | "chart">;
 ...
 * Primary content in *Hero → Primary*
 */
export interface HeroSliceHorizontalStackPrimary {
  /**
   * Heading field in *Hero → Primary*
   *
   * - **Field Type**: Title
...
/**
 * Horizontal Stack variation for Hero Slice
 *
 * - **API ID**: `horizontalStack`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroSliceHorizontalStack = prismic.SharedSliceVariation<
  "horizontalStack",
  Simplify<HeroSliceHorizontalStackPrimary>,
  never
>;
 ...
 */
type HeroSliceVariation = HeroSliceDefault | HeroSliceHorizontalStack;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceHorizontalStackPrimary,
      HeroSliceVariation,
      HeroSliceDefault,
      HeroSliceHorizontalStack,
    };
  }
}
